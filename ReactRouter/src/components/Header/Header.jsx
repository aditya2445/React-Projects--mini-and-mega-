...
//In Normal we write links using a tags but in react it provides a link tag coz using a tag it refreshes the whole page but in react there is no such concept of page refreshment...
